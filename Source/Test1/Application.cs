    ...
    namespace Application
    {
        ...
        class obj_Behavior : Jobs.iobj_Behavior<opaque_Event>
        {
            ...
            { 
                ...
                field_param.attr_engine(out engine);
                Jobs.opaque_Job<opaque_Event> job;
                engine.fattr_raise(new opaque_Event() { input = 1 }, out job);
        ...
        class comp_Application : API.Application.imod_Application<opaque_Event>
        {
            ...
            public bool fattr_Receive(IahaArray<char> param_input, out opaque_Event result) { result = default(opaque_Event); return true; }//{ result = new opaque_Event { input = new string(param_input.get()) }; return true; }
        }
